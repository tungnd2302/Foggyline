...
class InstallSchema implements InstallSchemaInterface
{
    public function install(SchemaSetupInterface $setup,ModuleContextInterface $context)
    {
        ...
        $table = $setup->getConnection()
             // Tạo bảng foggyline_office_department với 2 trường entity_id và name
            ...
            // Các mô hình EAV phân tán dữ liệu của họ trên một số bảng, tối thiểu là ba bảng
            // Tạo bảng foggyline_office_employee_entity
            ...
            // Tạo bảng foggyline_office_employee_entity_decimal
            $table = $setup->getConnection()
            ...
            ->addIndex(
                ...
                ->addForeignKey(
                    $setup->getFkName(
                        $employeeEntity . '_entity_decimal', 'store_id',
                        'store', 'store_id'
                    ),
                    'store_id',
